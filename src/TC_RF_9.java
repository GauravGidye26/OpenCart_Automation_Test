...
public class TC_RF_9 {
    ...
    public static void main(String[] args) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            ...
            WebElement dashboardHeading = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Your Account Has Been Created!')]")));
            
            Assert.assertTrue(dashboardHeading.isDisplayed(), "User is not redirected to the Account Dashboard after registration.");
